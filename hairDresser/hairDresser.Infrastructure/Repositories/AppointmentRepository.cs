...
namespace hairDresser.Infrastructure.Repositories
{
    public class AppointmentRepository : IAppointmentRepository
    {
        ...
        public AppointmentRepository()
        {
            ...
            AppointmentList.Add(new Appointment { CustomerName = "Vlad Apetrica", EmployeeName = "Onofras Rica", HairServiceName = "dye", StartDate = new DateTime(2022, 08, 15, 16, 38, 10), EndDate = new DateTime(2022, 09, 15, 17, 20, 10) });
            AppointmentList.Add(new Appointment { CustomerName = "Vlad Apetrica", EmployeeName = "Onofras Rica", HairServiceName = "dye", StartDate = new DateTime(2022, 08, 15, 13, 38, 10), EndDate = new DateTime(2022, 09, 15, 15, 20, 10) });
            ...
            AppointmentList.Add(new Appointment { CustomerName = "Adrian Marin", EmployeeName = "Matei Dima", HairServiceName = "cut, wash", StartDate = new DateTime(2022, 08, 19, 16, 30, 00), EndDate = new DateTime(2022, 08, 19, 18, 00, 00) });
            AppointmentList.Add(new Appointment { CustomerName = "Serb David", EmployeeName = "Matei Dima", HairServiceName = "cut, wash", StartDate = new DateTime(2022, 08, 19, 12, 20, 00), EndDate = new DateTime(2022, 08, 19, 14, 00, 00) });
            AppointmentList.Add(new Appointment { CustomerName = "Vlad Apetrica", EmployeeName = "Onofras Rica", HairServiceName = "cut, wash", StartDate = new DateTime(2022, 08, 19, 15, 38, 10), EndDate = new DateTime(2022, 08, 19, 17, 20, 10) });
            AppointmentList.Add(new Appointment { CustomerName = "Vlad Apetrica", EmployeeName = "Onofras Rica", HairServiceName = "cut, wash", StartDate = new DateTime(2022, 08, 19, 10, 38, 10), EndDate = new DateTime(2022, 08, 19, 13, 20, 10) });
        }
