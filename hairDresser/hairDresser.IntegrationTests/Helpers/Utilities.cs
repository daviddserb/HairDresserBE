    ...
    public static class Utilities
    {
        ...
        public static void InitializeDbForTests(DataContext db)
        {
            var hairService1 = new HairService
            {
                Id = 1,
                Name = "wash",
                Duration = new TimeSpan(00, 07, 00),
                Price = 49.99m
            };
            ...
            {
                Id = "80a9c339-2b14-4024-b548-1f782adbda25",
                UserName = "alfrenieB",
                Email = "afrenieBalas@gmail.eu",
                PhoneNumber = "-",
                Address = "-"
            };
            var customer2 = new User
            {
                Id = "1827e7ba-a97b-4326-ab6b-a847573d86e6",
                UserName = "mariangigea",
                Email = "marian$gigea@yahoo.com",
                PhoneNumber = "+40723143431",
                Address = "Brasov"
            };
            var employee1 = new User
            {
                Id = "e977b9be-b19c-47bb-bac2-813c3cbd2e97",
                UserName = "mirceaAnda",
                Email = "mircea32Anda@gmail.com",
                PhoneNumber = "+40721243421",
                Address = "Bucuresti"
            };
            var employee2 = new User
            {
                Id = "fdf45d4c-da75-4a63-aff6-cd9add4d327f",
                UserName = "alexandra33",
            ...
            var hairService1_employee2 = new EmployeeHairService
            {
                ...
                HairServiceId = hairService1.Id
            };
            var hairService2_employee2 = new EmployeeHairService
            {
                EmployeeId = employee2.Id,
                HairServiceId = hairService2.Id
            };
            ...
            {
                UserId = customer1.Id,
                RoleId = "e99e57d1-3805-4f7b-a139-94dc8791a999"
            };
            ...
            {
                UserId = employee1.Id,
                RoleId = "2dfc8605-fc95-40a4-8bb0-0ec6e270bdf8"
            };
