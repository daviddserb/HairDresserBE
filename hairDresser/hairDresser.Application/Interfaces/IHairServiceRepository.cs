...
namespace hairDresser.Application.Interfaces
{
    public interface IHairServiceRepository
    {
        ...
        Task<IQueryable<EmployeeHairService>> GetHairServicesByEmployeeId (Guid employeeId);
        Task<List<HairService>> GetMissingHairServicesByEmployeeId(Guid employeeId);
