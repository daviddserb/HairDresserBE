...
namespace hairDresser.Presentation.Profiles
{
    public class AppointmentProfile : Profile
    {
        public AppointmentProfile()
        {
            ...
            //When mapper.Map() is used (in Controllers), it converts the object's data type to another one => we need to specify the data types here, based on the data type of each property and its name.
            ...
            //Map the Appointment to AppointmentGetDto where we extract only CustomerName from the entire Customer type (same for the employee).
